...
-- INSERT INTO services(`name`, `description`,`duration`,`price`, `createdAt`, `updatedAt`) VALUES ('kitty', 'Hair/Barber', 'men haircut', 30, 65, SYSDATE(), SYSDATE());
...
INSERT INTO services(`name`, `description`,`duration`,`price`, `createdAt`, `updatedAt`) VALUES ('kitty', 'hair-barber', 'women haircut', 30, 65, SYSDATE(), SYSDATE());
